...
type OspfIfEntry struct {
	...
	IfType            string `DESCRIPTION: The OSPF interface type. By way of a default, this field may be intuited from the corresponding value of ifType. Broadcast LANs, such as Ethernet and IEEE 802.5, take the value 'broadcast', X.25 and similar technologies take the value 'nbma', and links that are definitively point to point take the value 'pointToPoint'., SELECTION: broadcast(1)/nbma(2)/pointToPoint(3)/pointToMultipoint(5)`
