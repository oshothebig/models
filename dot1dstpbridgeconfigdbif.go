...
func (obj Dot1dStpBridgeConfig) CreateDBTable(dbHdl *sql.DB) error {
	dbCmd := "CREATE TABLE IF NOT EXISTS Dot1dStpBridgeConfig " +
		...
		"PRIMARY KEY(Dot1dBridgeAddress, Dot1dStpVlan, Dot1dStpPriority) " +
		")"
...
func (obj Dot1dStpBridgeConfig) StoreObjectInDb(dbHdl *sql.DB) (int64, error) {
	var objectId int64
	dbCmd := fmt.Sprintf("INSERT INTO Dot1dStpBridgeConfig (Dot1dBridgeAddress, Dot1dStpVlan, Dot1dStpPriority, Dot1dStpBridgeMaxAge, Dot1dStpBridgeHelloTime, Dot1dStpBridgeForwardDelay, Dot1dStpBridgeForceVersion, Dot1dStpBridgeTxHoldCount) VALUES ('%v', '%v', '%v', '%v', '%v', '%v', '%v', '%v') ;",
		obj.Dot1dBridgeAddress, obj.Dot1dStpVlan, obj.Dot1dStpPriority, obj.Dot1dStpBridgeMaxAge, obj.Dot1dStpBridgeHelloTime, obj.Dot1dStpBridgeForwardDelay, obj.Dot1dStpBridgeForceVersion, obj.Dot1dStpBridgeTxHoldCount)
...
func (obj Dot1dStpBridgeConfig) GetObjectFromDb(objKey string, dbHdl *sql.DB) (ConfigObj, error) {
	...
	err = dbHdl.QueryRow(dbCmd).Scan(&object.Dot1dBridgeAddress, &object.Dot1dStpVlan, &object.Dot1dStpPriority, &object.Dot1dStpBridgeMaxAge, &object.Dot1dStpBridgeHelloTime, &object.Dot1dStpBridgeForwardDelay, &object.Dot1dStpBridgeForceVersion, &object.Dot1dStpBridgeTxHoldCount)
	fmt.Println("### DB Get Dot1dStpBridgeConfig\n", err)
	return object, err
}

func (obj Dot1dStpBridgeConfig) GetKey() (string, error) {
	key := string(obj.Dot1dBridgeAddress) + "#" + fmt.Sprintf("%d", obj.Dot1dStpVlan) + "#" + fmt.Sprintf("%d", obj.Dot1dStpPriority)
	return key, nil
}

func (obj Dot1dStpBridgeConfig) GetSqlKeyStr(objKey string) (string, error) {
	keys := strings.Split(objKey, "#")
	sqlKey := "Dot1dBridgeAddress = " + "\"" + keys[0] + "\"" + " and " + "Dot1dStpVlan = " + "\"" + keys[1] + "\"" + " and " + "Dot1dStpPriority = " + "\"" + keys[2] + "\""
	return sqlKey, nil
}
...
func (obj *Dot1dStpBridgeConfig) GetAllObjFromDb(dbHdl *sql.DB) (objList []*Dot1dStpBridgeConfig, e error) {
	...
	for rows.Next() {
		...
		if err = rows.Scan(&object.Dot1dBridgeAddress, &object.Dot1dStpVlan, &object.Dot1dStpPriority, &object.Dot1dStpBridgeMaxAge, &object.Dot1dStpBridgeHelloTime, &object.Dot1dStpBridgeForwardDelay, &object.Dot1dStpBridgeForceVersion, &object.Dot1dStpBridgeTxHoldCount); err != nil {
