...
type PolicyDefinitionStmtMatchPrefixSetCondition struct {
	BaseObj
	/*
...
func (obj PolicyDefinitionStmtMatchPrefixSetCondition) UnmarshalObject(body []byte) (ConfigObj, error) {
	var policyDefinitionStmtMatchPrefixSetCondition PolicyDefinitionStmtMatchPrefixSetCondition
	var err error
	if len(body) > 0 {
		if err = json.Unmarshal(body, &policyDefinitionStmtMatchPrefixSetCondition); err != nil {
			fmt.Println("### Trouble in unmarshaling PolicyDefinitionStmtMatchPrefixSetCondition from Json", body)
		}
	}
...
type PolicyDefinitionStmt struct {
	/*
    This class was auto-generated by the GOSTRUCT plugin for PYANG
    from YANG module openconfig-routing-policy_mod
...
func (obj PolicyDefinitionStmt) UnmarshalObject(body []byte) (ConfigObj, error) {
	var policyDefinitionStmt PolicyDefinitionStmt
	var err error
	if len(body) > 0 {
...
or export configuration statements. 
    */
	...
	Statement []PolicyDefinitionStmt}
